import argparse
from architecture import SqueezeExcitationBlock
...
def get_args():
    ...
    parser.add_argument("--r", type=str, required=True, help="reduction factor")
...
def main():
    ...
    onnx_generator.generate(SqueezeExcitationBlock, [hws, bs, cs, rs], args.save_dir, args.no_limit)
