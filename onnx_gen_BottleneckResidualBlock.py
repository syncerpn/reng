import argparse
from architecture import BottleneckResidualBlock
...
def get_args():
    ...
    parser.add_argument("--r", type=str, required=True, help="channel reduction factor")
...
def main():
    ...
    rs = list(map(int, args.r.split(",")))

    onnx_generator.generate(BottleneckResidualBlock, [hws, bs, cs, rs], args.save_dir, args.no_limit)
