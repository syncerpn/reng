...
HEADER_DEFAULT = [
    "name", "n_layers", "params", "ops", "mems_iop", "mems_wfmap", "mem_test", "operational_intensity_iop", "operational_intensity_wfmap", "operational_intensity_test",
    "fps_single", "fps_all", "fps_core_0", "fps_core_1", "fps_core_2", "fps_core_0_1", "fps_core_1_2", "fps_core_0_2",
    "throughput_single", "throughput_all", "throughput_core_0", "throughput_core_1", "throughput_core_2", "throughput_core_0_1", "throughput_core_1_2", "throughput_core_0_2",
]
...
def main():
    ...
    for model_name in meta_data:
        ...
        try:
            ...
            data_row = [model_name, d_n_layers, d_params, d_ops, d_mems_iop, d_mems_wfmap, d_mems_test, d_oi_iop, d_oi_wfmap, d_oi_test, *d_fpss, *d_throughputs, ]
